---
title: "Pa Sa CLSM growth curves disturbed"
...
PAO1_1<-GetData("/Volumes/Seagate Exp/GATECH images/12-12-17/results", positions, timepoints)

ggplot()+
    geom_point(data=PAO1_1,aes(x=timePoint, y=Biomass, color = Bug, shape = factor(position)), size=2)+
