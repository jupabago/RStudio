...
testVoxCoordsRed<-CorrectSampleVolume(IdVoxel(redImgInput),xytotal = 512, ztotal = 9, xydim=16, zdim=5)
testVoxCoordsGreen<-CorrectSampleVolume(IdVoxel(greenImgInput),xytotal = 512, ztotal = 9, xydim=13, zdim=4)
