...
RawBinning<-function(dfDistances, boxVol, binSize){#takes the list of pairwise distances between focus and object in box and outputs frequency density table binned by distances of 2 uM
  numDistances<-apply(dfDistances,1,as.numeric)#turn input df into numeric so hist() works
